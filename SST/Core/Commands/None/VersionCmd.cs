...
{
    /// <summary>
    ///     Command: Display the SST version and website address.
    /// </summary>
    public class VersionCmd : IBotCommand
    {
        ...
        public VersionCmd(SynServerTool sst)
        {
            _sst = sst;
        }
        ...
        {
            StatusMessage =
                string.Format("^7This server is running ^3SST (^5web: sst.syncore.org^3)^7" +
