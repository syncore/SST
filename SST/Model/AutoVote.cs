...
namespace SST.Model
{
    ...
    public class AutoVote
    {
        ...
        /// </summary>
        /// <value>The name of the admin who added this auto-vote rule.</value>
        public string AddedBy { get; private set; }

        /// <summary>
        /// Gets or sets the intended vote result.
        /// </summary>
        /// <value>The intended vote result.</value>
        public IntendedVoteResult IntendedResult { get; private set; }

        /// <summary>
        /// Gets the vote format display (for the UI).
        /// </summary>
        /// <value>The vote format display (for the UI).</value>
        ...
        /// </summary>
        /// <value><c>true</c> if the vote text has arguments; otherwise, <c>false</c>.</value>
        public bool VoteHasArgs { get; private set; }

        /// <summary>
        /// Gets or sets the text of the vote string.
        /// </summary>
        /// <value>The text of the vote string.</value>
