...
namespace SST.Model
{
    ...
    public class PlayerInfo
    {
        ...
        /// <remarks>This constructor is typically used with the 'configstrings' command.</remarks>
        ...
        /// </summary>
        /// <value>The player's accuracy data.</value>
        public AccuracyInfo Acc { get; set; }

        /// <summary>
        /// Gets or sets the clan tag, if any.
        /// </summary>
        /// <value>The clan tag, if any.</value>
        public string ClanTag { get; set; }

        /// <summary>
        /// Gets or sets the full player name including the clan tag.
        /// </summary>
        /// <value>The full player name including the clan tag.</value>
        ...
        /// </summary>
        /// <value>The QLRanks elo data.</value>
        public EloData EloData { get; set; }

        /// <summary>
        /// Gets or sets the full name of the clan.
        /// </summary>
        /// <value>The full name of the clan.</value>
        public string FullClanName { get; set; }

        /// <summary>
        /// Gets or sets a value indicating whether this player has made a successful sub request
        /// prior to prematurely leaving the game in the case of pick-up games.
        /// </summary>
        /// <value>
        /// <c>true</c> if this player has made a successful sub request prior to leaving a pick-up
        /// game early; otherwise, <c>false</c>.
        /// </value>
