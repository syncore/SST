...
namespace SST.Model.QlRanks
{
    ...
    /// value of a dictionary storing the QLRanks elo information for each player returned by the QL
    /// API. long type used because that's how it is received by the JSON.NET library.
    /// </summary>
    public class EloData
    {
        ...
        /// </summary>
        /// <value>The date and time on which the user's elo was last updated.</value>
        ...
        /// <returns>
        /// The type Elo value associated with a particular <see cref="QlGameTypes"/> enum.
        /// </returns>
