...
namespace SST.Ui.Validation.Modules
{
    ...
    public class IrcValidator
    {
        ...
        /// <param name="errorMsg">The error message.</param>
        /// <returns><c>true</c> if the user input is valid, otherwise <c>false</c></returns>
        /// <remarks>This is used for both nickname and username validation.</remarks>
        ...
        {
            // QuakeNet Q password is not required, but UI will prevent user from enabling auto-auth
            // without specifying Q password.
            errorMsg = string.Empty;
            return true;
        }
        ...
        public bool IsValidQuakeNetUsername(string userInput, out string errorMsg)
        {
            ...
            // QuakeNet Q username is not required, but UI will prevent user from enabling auto-auth
            // without specifying Q username.
            if (userInput.Contains(" ")) return false;
            errorMsg = string.Empty;
            return true;
        }
