...
namespace SST.Util
{
    ...
    public class Parser
    {
        ...
        /// <summary>
        ///     Regex for detecting when Quake Live crashes due to the infamous and still
        ///     un-resolved memory allocation error.
        /// </summary>
        /// <value>
        ///     Regex for detecting when Quake Live crashes due to the infamous and still
        ///     un-resolved memory allocation error.
        ...
        /// </value>
        /// <remarks>
        ///     This contains a named group, 'player' that has the name of the player who got disconnected. Note, this type of
        ///     disconnection
        ///     can happen when the game starts on passworded servers, where, for whatever reason, the player's configuration did
        ///     not set
